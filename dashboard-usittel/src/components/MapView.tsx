/**
 * 🗺️ Vista de Mapa de Red - Enlace Directo
 * 
 * Debido a limitaciones técnicas con el proxy del mapa interactivo de PRTG,
 * se ofrece un enlace directo para abrir el mapa en una nueva ventana
 */
...
export default function MapView({ sensors }: MapViewProps) {
  const PRTG_BASE_URL = 'http://38.253.65.250:8080';
  const DIRECT_MAP_URL = `${PRTG_BASE_URL}/public/mapshow.htm?id=2197&mapid=7418EC41-A903-47CF-87A2-70E6CC8AAFF5`;
